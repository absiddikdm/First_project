	...
	<div class="main-wrapper">
      ...
      <div class="sidebar-body">
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="advancedUI">
              <ul class="nav sub-menu">
                ...
                <li class="nav-item">
                    <a href="{{route('category.trash')}}" class="nav-link">Trash</a>
                  </li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('subscribe.list')}}" >
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="general-pages">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{route('author.req.list')}}" class="nav-link">Author Request</a>
                </li>
                <li class="nav-item">
                  <a href="{{route('author.list')}}" class="nav-link">Author List</a>
                </li>
              </ul>
            </div>
          </li>
