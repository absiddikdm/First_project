        ...
        <div class="row">  
            ...
            <div class="col-lg-12 col-md-12 ">
                    ...
                    <div class="image">
                        ...
                        <img style="width: 100px!important" src="{{ Avatar::create($author->username)->toBase64() }}" />
                              @else
                            <img style="width: 100px!important" src="{{asset('uploads/author')}}/{{$author->photo}}" alt="profile">
                             @endif
                        </a>
                    </div>
                    <div class="content">
                            ...
                            @foreach ($socials as $socials )
                                <li>
                                    <a href="{{ $socials->social_link }}">
                                        <i class="{{ $socials->icon_class }}" style="font-family: fontawesome;font-style:normal;background:rgb(7, 17, 150)"></i>
                                    </a>
                                </li>
                                @endforeach
                            </ul>
                ...
                <div class="theiaStickySidebar">
                    ...
                    <div class="post-list post-list-style4 pt-0"> 
                        <div class="post-list-image">
                            <a href="{{route('blog.details', $author_blog->slug)}}">
                                <img src=" {{ asset('uploads/post/thumb') }}/{{ $author_blog->thumbnail }} " alt="">
                            </a>
                        </div>
                        <div class="post-list-content">
                            <ul class="entry-meta"> 
                                <li class="entry-cat">
                                    <a href="{{route('cetegory.blog',$author_blog->category_id )}}" class="category-style-1">{{$author_blog->rel_to_cat->category_name}}</a>
                                </li>
                                <li class="post-date"> <span class="line"></span>{{$author_blog->created_at->diffForHumans()}}</li>
                            </ul>
                            <h5 class="entry-title">
                                <a href="{{route('blog.details', $author_blog->slug)}}"> {{$author_blog->title}} </a>
                            </h5>  
                            <div class="post-btn">
                                <a href="{{route('blog.details', $author_blog->slug)}}" class="btn-read-more">Continue Reading <i class="las la-long-arrow-alt-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <!--/-->
