                ...
                <div class="col-lg-12">
                    <!--post-single-image-->
                        <div class="post-single-image">
                            <img class="w-100" src=" {{ asset('uploads/post/cover') }}/{{ $post_details->cover_image }} " alt="">
                        </div>
                     ...
                     @if ($post_details->rel_to_author->photo == null)
                    <li class="post-author-img"><img src="{{ Avatar::create($post_details->rel_to_author->username)->toBase64() }}" /></li>
                      @else
                    <li class="post-author-img"><img src="{{asset('uploads/author')}}/{{$post_details->rel_to_author->photo}}" alt="profile"></li>
                     @endif
                    <li class="post-author"> <a href="author.html">{{ $post_details->rel_to_author->username }}</a></li>
                    <li class="entry-cat"> <a href="blog-layout-1.html" class="category-style-1 "> <span class="line"></span>{{ $post_details->rel_to_cat->category_name }}</a></li>
                    <li class="post-date"> <span class="line"></span> {{$post_details->created_at->diffForHumans()}}</li>
                    </ul>
                    </div>
                            ...
                            <div class="post-single-bottom"> 
                                <div class="tags">
                                    ...
                                    @php
                                       $after_explode_tags = explode(',', $post_details->tags);
                                    @endphp
                                    <ul class="list-inline">
                                        @foreach ($after_explode_tags as $tag)
                                        <li >
                        ...
                        @if ($post_details->rel_to_author->photo == null)
                        <img src="{{ Avatar::create($post_details->rel_to_author->username)->toBase64() }}" />
                        @else
                     <img src="{{asset('uploads/author')}}/{{$post_details->rel_to_author->photo}}" alt="profile">
                       @endif
                                        </a>
                                    </div>
                                    <div class="content">
                                        <h4>{{ $post_details->rel_to_author->username }}</h4>
                                        ...
                                        <div class="social-media">
                                            <ul class="list-inline">
                                                ...
                                                <i class=" {{$social->icon_class}}" style="font-family:Fontawesome; background:rgb(114, 114, 207)"></i>
                                                </a>
                                                </li>
                                                @endforeach
                                            </ul>
