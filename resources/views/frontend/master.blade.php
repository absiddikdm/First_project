...
<head>
    ...
    <!-- favicon -->
    <link rel="icon" sizes="16x16" href="{{asset('front')}}/img/favicon.png">
...
<body>
    ...
    <header class="header navbar-expand-lg fixed-top ">
        <div class="container-fluid ">
            <div class="header-area ">
                ...
                <div class="logo">
                    <a href="index.html">
                        <img src="{{asset('front')}}/img/logo/logo-dark.png" alt="" class="logo-dark">
                        <img src="{{asset('front')}}/img/logo/logo-white.png" alt="" class="logo-white">
                    </a>
                </div>
   ...
   <!--footer-->
    ...
    <script src="{{asset('front')}}/js/jquery.marquee.js"></script>
